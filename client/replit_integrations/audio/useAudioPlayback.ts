 ...
 * - seq 2 arrives â†â€™ buffered (waiting for seq 0)
 * - seq 0 arrives â†â€™ played immediately, then check buffer
 * - seq 1 arrives â†â€™ played immediately (seq 0 done), seq 2 now plays
 */
